 ...
 */
export class WeChatAdapter extends BaseContentAdapter {

	protected plugins: IProcessPlugin[] = [new ImagesPlugin(), new LinksPlugin(), new HeadingsPlugin(), new ListsPlugin(), new CodeBlocksPlugin(), new TablesPlugin(), new StylesPlugin()
